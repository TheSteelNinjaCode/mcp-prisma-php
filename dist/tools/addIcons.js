...
import { PPICONS_NAMES as KNOWN_ICONS } from "../resources/ppicons-names.js";
...
export function registerAddIcons(server, ctx) {
    server.registerTool("pphp.icons.add", {
        title: "Add PPIcons Icon(s)",
        description: "Adds SVG icon components from PPIcons (e.g., eye, user, chevron-right). Prefers local ppicons; optionally installs if missing.",
        inputSchema: {
...
//# sourceMappingURL=addIcons.js.map