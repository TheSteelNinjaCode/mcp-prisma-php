...
export function registerAddComponent(server, ctx) {
    server.registerTool("pphp.ui.addComponent", {
        title: "Add PHPXUI Component",
        description: "Adds one or more PHPXUI components (e.g., Dialog, Toast, DataTable). Prefers local phpxui; optionally installs if missing.",
        inputSchema: {
